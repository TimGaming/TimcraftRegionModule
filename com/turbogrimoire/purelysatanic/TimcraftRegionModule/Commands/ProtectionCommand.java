  ...
  implements CommandExecutor
{
  ...
  private boolean delegateProtectionCommand(Player player, String[] args)
  {
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      if (this.plugin.getWorldGuard().getRegionManager(selection.getWorld()).hasRegion(cleaned))
      {
      ...
      return childProtection(player, selection, region, regions, calculateCost);
    }
  }
  ...
  private boolean protection(Player player, Selection selection, ProtectedRegion region, boolean calculateCost)
  {
    ...
    if (ProtectionHandler.GetProtectionsByPlayer(player.getName()).size() == max)
    {
